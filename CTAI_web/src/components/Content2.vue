                ...
                <div style="height: 600px;" class="step_1">
                    <el-steps direction="vertical" :active="active" finish-status="success">
                        ...
                        <el-step style="height: 150px;" title="上传文件">
                            <template slot="description">
                                <!-- 上传文件 -->
                                上传CT图像至服务器，使用训练的模型分割病理并返回病理区域特征
            ...
            <div id="info_patient">
                ...
                <el-card style="border-radius: 8px;">
                    ...
                    <el-tabs v-model="activeName" @tab-click="handleClick">
                        <el-tab-pane label="病理区域特征值" name="first">
                            <!-- 表格存放特征值 -->
                            <el-table
                                :data="feature_list"
                                height="390"
    ...
    export default {
        ...
        methods: {
            ...
            downloads(data, name) {
                ...
                link.href = url;
                link.setAttribute("download", `病理图像文件.zip`);
            ...
            notice1() {
                this.$notify({
                    title: "预测成功",
                    message:
                        "点击图片可以查看大图，图片下方会显示病理区域的一些特征值来供医生参考，辅助诊断",
                    duration: 0,
                    type: "success"
                });
            }
