            ...
            >
                ...
                <div style="height: 600px;" class="step_1">
                    <el-steps direction="vertical" :active="active" finish-status="success">
                        ...
                        <el-step style="height: 150px;" title="步骤 1">
                            <template slot="description">
                                <!-- 上传文件 -->
                                上传眼底图像至服务器，使用训练的模型预测血管区域并返回血管区域特征
    ...
    export default {
        ...
        methods: {
            ...
            downloads(data, name) {
                ...
                link.href = url;
                link.setAttribute("download", `眼底血管图像文件.zip`);
            ...
            notice1() {
                this.$notify({
                    title: "预测成功",
                    message:
                        "点击图片可以查看大图，图片下方会显示血管区域的一些特征值来供医生参考，辅助诊断",
                    duration: 0,
                    type: "success"
                });
            }
