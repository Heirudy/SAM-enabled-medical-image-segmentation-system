    ...
    <div id="Content">
        ...
        >
            <el-steps :active="5" finish-status="process ">
                ...
                <el-step title="步骤1" style="width:260px;margin-left:-5px;">
        ...
        >
            ...
            <span slot="footer" class="dialog-footer">服务器性能有限，请耐心等待约30秒</span>
        </el-dialog>
            ...
            >
                ...
                <div style="height: 600px;" class="step_1">
                    <el-steps direction="vertical" :active="active" finish-status="success">
                        ...
                        <el-step style="height: 150px;" title="上传文件">
                            <template slot="description">
                                <!-- 上传文件 -->
                                上传CT图像至服务器，使用训练的模型分割肺部并返回肺部区域特征
        ...
        <!-- 上传返回信息部分：原CT图部分  标出肺部的CT图像 图像特征-->
        <div id="CT">
            <!-- CT图像 -->
            <div id="CT_image">
                <!-- 原CT图 -->
            ...
            <div id="info_patient">
                ...
                <el-card style="border-radius: 8px;">
                    ...
                    <el-tabs v-model="activeName" @tab-click="handleClick">
                        <el-tab-pane label="肺部区域特征值" name="first">
                            <!-- 表格存放特征值 -->
                            <el-table
                                :data="feature_list"
                                height="390"
    ...
    export default {
        ...
        methods: {
            ...
            downloads(data, name) {
                ...
                link.href = url;
                link.setAttribute("download", `肺部CT图文件.zip`);
            ...
            notice1() {
                this.$notify({
                    title: "预测成功",
                    message:
                        "点击图片可以查看大图，图片下方会显示肺部区域的一些特征值来供医生参考，辅助诊断",
                    duration: 0,
                    type: "success"
                });
            }
